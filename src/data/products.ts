...
export const products: Product[] = [
  // ========== VISUAL / LUX ==========
  {
    ...
    longDescription:
      "Most sleep masks press on your eyelids. This one doesn't. The eye cups are molded 3D so they float around your eyes instead of on them. Total blackout, zero pressure. Micro-hook strap won't snag your hair either.",
    features: [
    ...
    science: [
      {
        ...
        detail:
          "5 lux of light through closed eyelids cuts melatonin by 50%. This mask gets it under 0.1 lux. That's biologically pitch black.",
      },
      {
        title: "REM Protection",
        detail:
          "Pressure on your eyelids during REM triggers micro-wakeups. The 3D shape removes that problem.",
      },
    ],
