...
export default function OlfactoryPage() {
  const data = senseData["olfactory"];
  const products = getProductsBySense("olfactory");
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <Wind size={24} className="text-moonlight" weight="duotone" />
          ...
          <h1 className="font-[family-name:var(--font-display)] text-3xl md:text-5xl font-bold tracking-tighter text-cream leading-[1.1] max-w-[20ch] mx-auto">
            {data.title}: <span className="text-moonlight">OLFACIO</span>
          </h1>
