        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
            {[
              ...
              { title: "Blue Light & Circadian System", journal: "Molecular Vision, 2016 · IF 2.2", authors: "Tosini G, Ferguson I, Tsubota K", finding: "Melanopsin RGCs peak at ~460nm. Blue light delays melatonin 3+ hours.", pmid: "PMID 26900325", url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC4734149/" },
