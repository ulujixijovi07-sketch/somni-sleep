...
export default function TactilePage() {
  const data = senseData["tactile"];
  const products = getProductsBySense("tactile");
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <Hand size={24} className="text-moonlight" weight="duotone" />
          ...
          <h1 className="font-[family-name:var(--font-display)] text-3xl md:text-5xl font-bold tracking-tighter text-cream leading-[1.1] max-w-[20ch] mx-auto">
            {data.title}: <span className="text-moonlight">TACTUS</span>
          </h1>
