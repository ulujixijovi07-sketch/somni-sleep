...
const TEMPLATES = [
  ...
  "I was hesitant to order sleep products online but {product} is worth every penny. {adj_cap} craftsmanship, {adj2} details — this is luxury you can feel.",
  "This is my {number}th purchase from SOMNI and {product} might be my favorite yet. The {color} color is even more {adj} in person.",
  "As a {size} I struggle to find {adj} sleep products that actually work. {product} delivers! Supportive where it needs to be, {adj2} everywhere else.",
  ...
  "FINALLY — {adj} sleep essentials for {size} that doesn't look like it was designed by someone who's never seen curves. {product} is a game changer.",
  ...
  "I own over {number} sets from SOMNI and {product} stands out for its {adj} {material} and {adj2} fit. True to size, incredibly comfortable.",
